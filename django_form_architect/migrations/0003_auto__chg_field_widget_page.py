...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('django_form_architect_widget', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_form_architect.Page'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Widget.page'
        raise RuntimeError("Cannot reverse this migration. 'Widget.page' and its values cannot be restored.")
    ...
    models = {
        ...
        'django_form_architect.widget': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['django_form_architect.Page']", 'null': 'True'}),
            'pid': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
